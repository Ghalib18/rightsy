          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
            <div className="w-full md:w-1/2 text-center md:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <Button
                  size="lg"
                  className="bg-white text-purple-700 hover:bg-purple-100 font-bold text-lg px-8 py-6 rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1"
                >
                  Start Learning
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-white text-white hover:bg-purple-500 font-bold text-lg px-8 py-6 rounded-xl"
                >
                  Explore Games
                </Button>
              </div>
            ...
            <div className="w-full md:w-1/2">
              <div className="relative">
                ...
                <div className="relative bg-white rounded-xl shadow-xl overflow-hidden border-4 border-purple-100 transform hover:scale-105 transition-transform duration-300">
                  <img src="/image2.jpg" alt="Children learning" className="w-full h-auto" />
                </div>
              </div>
            </div>
